...
import money.pojo.IndexData;
import money.util.SpringContextUtil;
...
public class IndexDataService {
    ...
    public List fetch_indexes_from_third_part(String code){
        List temp= restTemplate.getForObject("http://127.0.0.1:8090/indexes/"+code+".json",List.class);
